 ...
 * holds. A single pass leaves a set where every remaining clue is necessary: once a removal fails,
 * later removals only weaken the puzzle, so it would fail again.
 */
